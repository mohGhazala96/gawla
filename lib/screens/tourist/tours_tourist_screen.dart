      ...
      Row(
          ...
          child: Align(
            ...
            child: GestureDetector(
                ...
                child:
                    Icon(Icons.arrow_back_ios, color: Colors.black, size: 35.0)),
          ),
        ),Padding(
          padding: const EdgeInsets.only(top:30,left: 10),
          child: Text('My Bookings',style: TextStyle(fontSize: 20,color: Colors.white,fontFamily: 'Poppins',fontWeight: FontWeight.bold)),
        )],
      ),
      new Expanded(
          child: GridView(
